...
// signed integers
char* bytestring_builder_int_dec (int x, char* buf)
{
...
char* bytestring_builder_long_long_int_dec (long long int x, char* buf)
{
    char c, *ptr = buf, *next_free;
    long long int x_tmp;
...
// unsigned integers
char* bytestring_builder_uint_dec (unsigned int x, char* buf)
{
    char c, *ptr = buf, *next_free;
    unsigned int x_tmp;
...
// unsigned long ints
char* bytestring_builder_long_long_uint_dec (long long unsigned int x, char* buf)
{
    char c, *ptr = buf, *next_free;
...
void bytestring_builder_int_dec_padded9 (int x, char* buf)
{
...
void bytestring_builder_long_long_int_dec_padded18 (long long int x, char* buf)
{
