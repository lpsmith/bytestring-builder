...
foreign import ccall unsafe "static bytestring_builder_int_dec" c_int_dec
    :: CInt -> Ptr Word8 -> IO (Ptr Word8)

foreign import ccall unsafe "static bytestring_builder_long_long_int_dec" c_long_long_int_dec
...
foreign import ccall unsafe "static bytestring_builder_uint_dec" c_uint_dec
    :: CUInt -> Ptr Word8 -> IO (Ptr Word8)

foreign import ccall unsafe "static bytestring_builder_long_long_uint_dec" c_long_long_uint_dec
